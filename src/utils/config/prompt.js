export const ANALISE_PROMPT = `Você é um engenheiro de software sênior e está encarregado de realizar uma análise profunda no código a seguir abordando os seguintes critérios:
...
export const COMPLEXIDADE_PROMPT = `Você é um engenheiro de sofware sênior e está fazendo uma análise de código fonte abaixo para avaliar a complexidade ciclomática de acordo com os parâmetros de McCabe:
